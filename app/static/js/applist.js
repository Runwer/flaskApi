(function () {
  ...
  MovieController.$inject = ['MovieDataService', '$http', 'MovieListService', '$rootScope', '$cookies'];
  function MovieController(MovieDataService, $http,MovieListService, $rootScope, $cookies) {
    var moviectrl = this;
    // Retrieving a cookie
